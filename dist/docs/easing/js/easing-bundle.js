...
"use strict";
var easingDoc = require('./easing-doc').default;
...
var EasingVis = require('./easing-vis').default;
...
var EasingVis = function EasingVis(canvasId, easingFn, duration) {
...
($traceurRuntime.createClass)(EasingVis, {
  go: function() {
    this._updateBound(0);
  },
  _update: function(ts) {
  ...
  _drawNode: function(delta, x, easingFn, color) {
    var xExpandOffset = arguments[4] !== (void 0) ? arguments[4] : null;
    this._elapsed += delta;
    if (this._elapsed >= this.duration) {
      this._elapsed -= this.duration;
    }
  ...
  _createPathBuffer: function(w, h, d, offset) {
    var canvas = document.createElement('canvas');
    canvas.width = w;
    canvas.height = h;
