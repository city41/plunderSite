...
(function() {
  define('.tmp/scripts/easing/easingVis',['plunder', '../raf'], function(Plunder) {
    var EasingVis;
...
(function() {
  define('.tmp/scripts/domReady',[],function() {
...
(function() {
  ...
  define('.tmp/scripts/easing/easingDoc',['plunder', './easingVis', '../domReady'], function(Plunder, EasingVis, domReady) {
...
define(".tmp/scripts/docs/main", function(){});
}());